        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6">
          {displayedProducts.map((product) => {
            ...
            return (
              ...
              >
                <div className="relative h-40 sm:h-56 overflow-hidden bg-slate-100 p-2.5 sm:p-4 flex items-center justify-center">
                  <img
                    src={product.image}
                    alt={product.name}
                  ...
                  <div className="absolute top-2 left-2 sm:top-3 sm:left-3 flex flex-col gap-1 z-10">
                    {product.badge && (
                      <span className="bg-[#0057FF] text-white text-[9px] sm:text-[10px] font-black px-2 sm:px-2.5 py-0.5 rounded-full shadow-xs">
                        {product.badge}
                      </span>
                    )}
                  </div>
                  ...
                  {product.discountPercent > 0 && (
                    <span className="absolute top-2 right-2 sm:top-3 sm:right-3 bg-amber-400 text-slate-900 text-[9px] sm:text-[10px] font-black px-2 sm:px-2.5 py-0.5 rounded-full shadow-xs">
                  ...
                  <button
                    ...
                    className="absolute bottom-2 right-2 sm:bottom-3 sm:right-3 bg-white/90 backdrop-blur-md text-slate-900 p-1.5 sm:p-2 rounded-full shadow-md opacity-0 group-hover:opacity-100 transition-opacity hover:bg-white cursor-pointer"
                    title="Quick View"
                  >
                    <Eye className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#0057FF]" />
                  </button>
                </div>
                ...
                <div className="p-3.5 sm:p-5 flex-1 flex flex-col justify-between space-y-3 sm:space-y-4">
                  <div className="space-y-1.5 sm:space-y-2">
                    ...
                    <h3
                      onClick={() => onOpenQuickView(product)}
                      className="font-bold text-xs sm:text-base text-slate-900 hover:text-[#0057FF] transition-colors cursor-pointer line-clamp-2 leading-snug"
                    >
                      {product.name}
                    </h3>
                    ...
                    <div className="flex items-baseline gap-1.5 sm:gap-2 pt-1 sm:pt-2">
                      <span className="text-base sm:text-xl font-black text-[#0057FF]">
                        {product.price} QAR
                      </span>
                  ...
                  <div className="space-y-1.5 sm:space-y-2 pt-2 border-t border-gray-100">
                    <div className="grid grid-cols-2 gap-1.5 sm:gap-2">
                      <button
                        ...
                        className="py-2 sm:py-2.5 px-1 bg-[#0057FF] text-white font-extrabold text-[10px] sm:text-xs rounded-xl shadow-xs hover:bg-blue-700 transition-colors flex items-center justify-center gap-1 cursor-pointer"
                      >
                      ...
                      <button
                        ...
                        className="py-2 sm:py-2.5 px-1 bg-amber-400 hover:bg-amber-300 text-slate-900 font-extrabold text-[10px] sm:text-xs rounded-xl shadow-xs transition-colors cursor-pointer text-center truncate"
                      >
                        Buy Now
                      </button>
                    </div>
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-full py-1.5 sm:py-2 bg-emerald-50 text-emerald-700 hover:bg-emerald-500 hover:text-white border border-emerald-200 font-bold text-[10px] sm:text-xs rounded-xl transition-all flex items-center justify-center gap-1.5"
                    >
